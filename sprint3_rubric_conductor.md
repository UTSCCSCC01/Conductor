...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1 Feedback: Decision about the user story that needs to be completed is missing
...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 8 / 10 Feedback: 1 member did not post update after sprint 3 standup 1 excluding Jason
...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1 Feedback: CON-67 and 87 missing user story template
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1 Feedback: Several task are not broken down into tasks and subtasks
