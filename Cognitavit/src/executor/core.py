...
platform_exec = execute_factory.create(platform_name) # platform_exec = execute_factory.create('win')
...
device_type = platform_name.lower().strip()
if (device_type == 'win'):
    ...
    ps = platform_exec.native_exec("google-chrome-stable", r" --incognito https://www.youtube.com/watch?v=LhOSM6uCWxk ", dev, 0)
    sleep(3)
    ...
    raise ValueError('unknown platform not supported')
