...
*(Convention: N=sprint number, ex: sprintN.md means sprint2.md for sprint 2, and SR(N-1)md means SR1.md for sprint 2, that is Sprint Retrospective for Sprint 2, to be hold during planning meeting at the beginning of Sprint 2)*
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1 Feedback: Many pull requests are missing and don't match Jira
  ...
  - Is the pull request done by the person to whom the task has been assigned to?  (max 2 marks)
    ...
    Your Mark: 1 Feedback: Several tasks were incomplete
  ...
  - Is each pull request made from a separate branch for each individual task? (max 5 marks)
    ...
    Your Mark: 4 Feedback: ~ 4 pull requests were made
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 1 Feedback: sprint2.md indicated all members had a task but pull requests and commits don't match
  ...
  - Burndown chart (max 2 marks)
    ...
    Your Mark: 1 Feedback: Burndown chart doesn't match and Sprint 2 needs to be closed in Jira
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 4 / 20 Feedback: Only one user story completed
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 2 Feedback: User and Interface do not follow the Single Responsibility principle also some details are irrelevant please look at examples of CRC cards.
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 3 Feedback: An brief explanation is needed 
...
## Documentation (max 1 mark)
  ...
  Your Mark: 0 / 1 Feedback: ReadMe needs to be updated
