...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 7 / 10 Feedback: There are 4 questions to answer. Some groups members don't have a minimum of 3 standup messages 
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 3 Feedback: Class user has a lot of responsibilities - try to follow the single responsibility principle. 
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 3 Feedback: What are the names of the microservices? 
    
    Total System Design: 8 / 10
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
    ...
    Your Mark: 7 Feedback: There was an error logging in for one case.
