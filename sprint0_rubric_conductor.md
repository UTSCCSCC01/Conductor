...
**Team Name:** Conductor 
**Github:** https://github.com/UTSCCSCC01/finalprojects22-conductor 
...
## summary.md (Max 8 marks)
  - Project objectives have been specified clearly (max 2 marks)   
    ...
    Your mark: 1 Feedback: Vague description. It's assuming everything can be scheduled via automation, which is a bit utopian. The language is for a technical audience rather than general.
  ...
  - Scenarios have been described clearly (max 2 marks)    
    ...
    Your mark: 1 Feedback: What's the difference between "enterprise users" and "power users"? Now, those who upload bots to the marketplace need to have programming knowledge - is it possible to create a bot with a few clicks?
  ...
  - Principles have been described clearly (max 2 marks)
    ...
    Your mark: 1 Feedback: More than 1 principle needed.
    
  summary.md Total Mark: 5 / 8
...
## competition.md (Max 2 marks)
  ...
  competition.md Total Mark: 2 / 2 Feedback: Excellent!
...
## Process: process.md (max 10 marks)
  - Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1 Feedback: Who was doing what in Sprint 0? e.g. Student A did the personas, Student B did the readme, etc.
  ...
  - Next phase (max 2 marks)
    ...
    Your mark: 1 Feedback: What about workload? Jira?
