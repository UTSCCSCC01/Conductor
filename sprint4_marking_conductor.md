...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 0 Feedback: Many aspects missing, difference between sprint 3 and 4 sprint.md file in terms of information
...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 5 / 10 Feedback: 3 member forgot to post their sprint 4 standup 3 excluding jason. 1 member did not post after sprint 3 standup 1
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1 Feedback: Not all stories are broken down into subtasks
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 1  Feedback: CON-66, 74, 95, 97, and 99 missing COS
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1 Feedback: Several pull requests are missing because of the many tasks are not divided into subtasks 
  ...
  - Is the pull request done by the person to whom the task has been assigned to?  (max 2 marks)
    ...
    Your Mark: 1 Feedback: Only about 4 people from the group are doing the pull requests
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 2 Feedback: Only 4 people were assigned tasks
  ...
  - Schedule (max 2 marks)
    ...
    Your Mark: 0 Feedback: Same schedule submitted as Sprint 3
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 2 Feedback: Same document as Sprint 2 submitted? There were no changes in terms of classes and CRC?
...
## Documentation (max 1 mark)
  ...
  Your Mark: 0 / 1 Feedback: Not updated 
